...
export default async function ModelPage({ params }: PageProps) {
  ...
  return (
    <main className="page-main" id="main-content"><div className="site-shell">
      <Breadcrumbs ariaLabel={content.messages.ui.breadcrumb} items={[{ label: content.messages.ui.home, href: paths.home(locale) }, { label: category.name, href: paths.category(locale, category) }, { label: manufacturer.name, href: paths.manufacturer(locale, category, manufacturer) }, { label: model.name }]} />
